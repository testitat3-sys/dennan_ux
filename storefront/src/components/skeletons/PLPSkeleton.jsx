  ...
  return (
    <Page noPaddingTop={true} padding="inset" bottomSpacing="loose" aria-hidden="true">
      ...
      <Page.Section as="header" fullBleed className="plp-skel__hero">
        ...
        <div className="plp-skel__hero-content">
          <div className="plp-skel__hero-shape" aria-hidden="true" />
          <div className="plp-skel__title skeleton-shimmer" />
          <div className="plp-skel__subtext skeleton-shimmer" />
        </div>
      </Page.Section>
