              ...
              <div className="tracking-map">
                <div className="map-canvas">
                  ...
                  <div className="map-marker rider pulse">
                    ...
                    <div className="marker-label">{rider.name.split(' ')[0]}</div>
                  </div>
          ...
          <div className="rider-card">
            <div className="rider-info-grid">
              ...
              <div className="rider-details">
                ...
                <p className="rider-meta">On a {rider.bike}</p>
              </div>
            </div>

            <button className="btn-call-rider" onClick={() => window.location.href = `tel:${rider.phone}`}>
