...
const CheckoutPage = () => {
  ...
  const handlePlaceOrder = async () => {
    if (!cartItems || cartItems.length === 0) {
      setToastConfig({
        isOpen: true,
        message: "Your cart is empty! Add items to place an order.",
        variant: 'danger'
      });
      return;
    }
              ...
              <Page.Section className="confirmation-hero-section">
                <Card className="confirmation-hero" hasBorder={false} hasShadow={false} hasBackground={false}>
                  <Card.Body align="center">
                    ...
                    <Text role="display-sm" as="h1" className="confirmation-title">Order Confirmed</Text>
                    ...
                    <Card className="eta-card" hasShadow={true} hasBackground={true} style={{ margin: 'var(--space-12) auto 0' }}>
                      <Card.Body align="center">
                        ...
                        <Text role="display-sm" as="div" color="anchor" className="eta-time">{lockedETA?.timeString}</Text>
                ...
                <div className="confirmation-actions">
                  ...
                  <div className="secondary-promos">
                    {checkoutData?.confirmation?.promos?.map(promo => (
                      ...
                      >
                        <Card.Header>
                          <Text role="title-lg" as="h4">{promo.title}</Text>
                        </Card.Header>
                        <Card.Body>
                          <Text role="body-sm" as="p" color="secondary">{promo.desc}</Text>
                          <Card.Actions>
                            <Button variant="link">{promo.action}</Button>
                          </Card.Actions>
                        </Card.Body>
                      </Card>
                    ))}
